...
export const BIT_USAGE = '$0 usage: bit [--version] [--help] <command> [<args>]';

export const BIT_DESCRIPTION = `is a free and open source tool for turning components from existing source-code to a collection of reusable components.
easily share, reuse, maintain and discover code components from any project.

bit documentation: https://docs.bit.dev';`;

export const BIT_EPILOGUE = `please use 'bit <command> --help' for more information and guides on specific commands.`;
